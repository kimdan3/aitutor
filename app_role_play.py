...
st.set_page_config(page_title="Role Play", layout="wide")
...
roleplays = {
    'hamburger': {"display_name":'Order a hamburger', 'emoji': '🍔', 'difficulty': '⭐️'},
    'immigration': {'display_name':'Go through immigration', 'emoji': '🏦', 'difficulty': '⭐️'},
    'restaurant': {'display_name': 'Order food at a restaurant', 'emoji': '🍝', 'difficulty': '⭐️⭐️'},
    'museum': {'display_name':'Enjoy the museum', 'emoji': '🏛️', 'difficulty': '⭐️⭐️'},
    'accommodation': {'display_name': 'Ask an Airbnb host some questions', 'emoji': '🏠', 'difficulty': '⭐️⭐️⭐️'}
}
